    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row lg:items-start gap-8">
        <div className="flex-1 min-w-0">
          <h2 className="text-4xl font-bold tracking-tight leading-tight mb-2">
            {proposal?.name}
          </h2>
        ...
        <div className="w-full lg:w-[380px] flex-shrink-0">
          {/* Action Buttons - Two columns in one row with equal width */}
          <div className="flex gap-2 mb-4">
            <Link href={`/proposals/${proposal.id}/edit`} className="w-1/2">
              <Button
                variant="outline"
                size="default"
